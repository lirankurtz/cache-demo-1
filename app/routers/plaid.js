...
router.route('/').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
      const retValue = {
        success: true,
        message: "Hello from plaid route!"
      }
...
router.route('/create_link_token_for_payment').post(
...
router.route('/set_access_token').post(function (request, response, next) {
...
router.route('/auth').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/transactions').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/investments_transactions').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/identity').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/balance').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
// https://plaid.com/docs/#investments
router.route('/holdings').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/liabilities').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/item').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/accounts').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/assets').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/transfer').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/payment').get(function (request, response, next) {
  Promise.resolve()
    .then(async function () {
...
router.route('/income/verification/paystubs').get(function (request, response, next) {
  Promise.resolve()
  .then(async function () {
